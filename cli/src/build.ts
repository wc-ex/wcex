...
function _upgradeVerson(pkgFile: string): { name: string; version: string , dependencies:string[]|undefined} {
	// 升级版本号
 ...
 */
async function buildHtmlProject() {
	// 初始化目录
...
export function build(opts: { dir: string; packDir: string }) {
	try {
